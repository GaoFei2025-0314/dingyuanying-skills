...
docs/article.html                     # 长文《无处等待救世主》（同内容另有 article.md）
...
《[无处等待救世主](docs/article.md)》——把三套方法连成一篇文章讲清楚：为什么把丁元英当"神"来崇拜恰恰是误读，三个人各自的方法和各自的盲区，以及叶晓明、刘冰、林雨峰这三面反向的镜子。浏览器打开 `docs/article.html` 是排版版本。
